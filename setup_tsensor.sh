...
sudo systemctl status tsensor.service || echo "Failed to start tsensor service."
...
sudo systemctl status flask   || { echo "Failed to start tsensor web service. Exiting."; exit 1; }
